...
export const ROTATION: ModelConfig[] = [
    { provider: "anthropic", model: "claude-3-5-sonnet-20241022", label: "Claude 3.5 Sonnet" }, // Using modern sonnet ref (as claude-sonnet-4-20250514 is a future preview code in prompt)
